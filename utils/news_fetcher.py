...
MEDIA_FEEDS = [
    ...
    {"url": "https://www.mediapart.fr/articles/feed",                           "source": "mediapart.fr"},
    {"url": "https://feeds.leparisien.fr/leparisien/rss/politique",             "source": "leparisien.fr"},
    {"url": "https://www.la-croix.com/rss",                                     "source": "la-croix.com"},
    {"url": "https://www.humanite.fr/feed",                                     "source": "humanite.fr"},
    {"url": "https://www.latribune.fr/feed.xml",                               "source": "latribune.fr"},
    {"url": "https://www.challenges.fr/rss.xml",                               "source": "challenges.fr"},
    {"url": "http://www.slate.fr/rss.xml",                                      "source": "slate.fr"},
    {"url": "https://www.courrierinternational.com/feed/all/rss.xml",           "source": "courrierinternational.com"},
    {"url": "https://www.valeursactuelles.com/feed",                            "source": "valeursactuelles.com"},
    {"url": "https://www.ouest-france.fr/rss/une",                              "source": "ouest-france.fr"},
    {"url": "https://www.20minutes.fr/feeds/rss-politique.xml",                 "source": "20minutes.fr"},
    # TV & radio
    ...
    {"url": "https://www.bfmtv.com/rss/politique/",                             "source": "bfmtv.com"},
    {"url": "https://www.radiofrance.fr/franceinter/rss",                       "source": "franceinter.fr"},
    {"url": "https://www.radiofrance.fr/franceculture/rss",                     "source": "franceculture.fr"},
    # 杂志 / people（人物专访、单人采访、关系类内容常出现在这里，按人名过滤后入库）
    {"url": "https://www.society-magazine.fr/feed/",                            "source": "society-magazine.fr"},
    {"url": "https://www.parismatch.com/rss/Actu.xml",                          "source": "parismatch.com"},
    {"url": "https://vsd.fr/feed/",                                             "source": "vsd.fr"},
    {"url": "https://www.public.fr/feed",                                       "source": "public.fr"},
    {"url": "https://www.closermag.fr/feed",                                    "source": "closermag.fr"},
    {"url": "https://www.nouvelobs.com/people/rss.xml",                         "source": "nouvelobs.com"},
    {"url": "https://www.telerama.fr/rss/une.xml",                              "source": "telerama.fr"},
    {"url": "https://www.lesinrocks.com/feed/",                                 "source": "lesinrocks.com"},
    {"url": "https://www.vanityfair.fr/feed/rss",                               "source": "vanityfair.fr"},
    {"url": "https://www.gqmagazine.fr/feed/rss",                               "source": "gqmagazine.fr"},
